      ...
      , G = async () => {
        try {
            ...
            const Te = ne
              ...
              , Ht = typeof Te == "object" && typeof Te.status == "number" ? Te.status : 200;
            (Ht === 401 || Ht === 419) && (c({
                message: ht,
                type: "error"
            }),
      ...
      , x = async () => {
        ...
        try {
            ...
            const ee = $
              ...
              , ie = typeof ee == "object" && typeof ee.status == "number" ? ee.status : 200;
            (ie === 401 || ie === 419) && (g({
                message: J,
                type: "error"
            }),
      ...
      , v = async () => {
        try {
            ...
            const B = L
              ...
              , _ = typeof B == "object" && typeof B.status == "number" ? B.status : 200;
            (_ === 401 || _ === 419) && (m({
                message: Q,
                type: "error"
            }),
    ...
    const Q = async () => {
        ...
        try {
            ...
            const N = P
              ...
              , Y = typeof N == "object" && typeof N.status == "number" ? N.status : 200;
            (Y === 401 || Y === 419) && (T({
                message: O,
                type: "error"
            }),
    ...
    const _ = async () => {
        ...
        try {
            ...
            const H = j
              ...
              , X = typeof H == "object" && typeof H.status == "number" ? H.status : 200;
            (X === 401 || X === 419) && (T({
                message: Z,
                type: "error"
            }),
      ...
      , v = async () => {
        ...
        try {
            ...
            const _ = Q
              ...
              , ee = typeof _ == "object" && typeof _.status == "number" ? _.status : 200;
            (ee === 401 || ee === 419) && (g({
                message: $,
                type: "error"
            }),
    ...
    const T = async () => {
        try {
            ...
            const $ = _
              ...
              , J = typeof $ == "object" && typeof $.status == "number" ? $.status : 200;
            (J === 401 || J === 419) && (m({
                message: ee,
                type: "error"
            }),
    ...
    const L = async () => {
        ...
        try {
            ...
            const te = Y
              ...
              , H = typeof te == "object" && typeof te.status == "number" ? te.status : 200;
            (H === 401 || H === 419) && (x({
                message: j,
                type: "error"
            }),
      ...
      , B = async () => {
        ...
        try {
            ...
            const P = W
              ...
              , O = typeof P == "object" && typeof P.status == "number" ? P.status : 200;
            (O === 401 || O === 419) && (x({
                message: N,
                type: "error"
            }),
      ...
      , A = async () => {
        ...
        try {
            ...
            const W = ue
              ...
              , N = typeof W == "object" && typeof W.status == "number" ? W.status : 200;
            (N === 401 || N === 419) && (v({
                message: P,
                type: "error"
            }),
    ...
    const Q = async () => {
        ...
        try {
            ...
            const Z = H
              ...
              , le = typeof Z == "object" && typeof Z.status == "number" ? Z.status : 200;
            (le === 401 || le === 419) && (T({
                message: X,
                type: "error"
            }),
      ...
      , _ = async () => {
        ...
        try {
            ...
            const O = N
              ...
              , te = typeof O == "object" && typeof O.status == "number" ? O.status : 200;
            (te === 401 || te === 419) && (T({
                message: Y,
                type: "error"
            }),
        ...
        children: [v && f.jsx(Mt, {
            ...
            children: [f.jsx(oe.button, {
               ...
               ${d || !x ? "bg-gray-400 cursor-not-allowed" : "bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer"}`,
                onClick: x ? Q : void 0,
                children: d ? ((he = s == null ? void 0 : s.checking) == null ? void 0 : he[l]) + "..." : (ue = s == null ? void 0 : s.lblProceed) == null ? void 0 : ue[l]
            }), f.jsx(oe.button, {
                onClick: _,
                disabled: !U,
                className: `text-white mb-2 mt-2 md:ml-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition ${U ? "bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer" : "bg-gray-400 cursor-not-allowed"}`,
    ...
    const le = async () => {
        try {
            ...
            const de = se
              ...
              , ze = typeof de == "object" && typeof de.status == "number" ? de.status : 200;
            (ze === 401 || ze === 419) && (p({
      ...
      , G = async se => {
        ...
        try {
            ...
            const ze = ot
              ...
              , Je = typeof ze == "object" && typeof ze.status == "number" ? ze.status : 200;
            (Je === 401 || Je === 419) && (p({
                message: "Unauthorized, session timed out",
                type: "error"
            }),
...
` + P[0],
        ...
        if (he) {
            ...
            try {
                ...
                const ve = G
                  ...
                  , we = typeof ve == "object" && typeof ve.status == "number" ? ve.status : 200;
                (we === 401 || we === 419) && (g({
                    message: ye,
                    type: "error"
                }),
        ...
        if (ve && ye)
            try {
                ...
                const He = we
                  ...
                  , at = typeof He == "object" && typeof He.status == "number" ? He.status : 200;
                (at === 401 || at === 419) && Lt(l),
                g({
                    message: Ve,
                    type: "error"
  ...
  , mw = ({setActiveStep: n}) => {
      ...
      , Aa = async () => {
        try {
            ...
            const fe = ce
              ...
              , Ae = typeof fe == "object" && typeof fe.status == "number" ? fe.status : 200;
            (Ae === 401 || Ae === 419) && (h({
                message: Re,
                type: "error"
            }),
        ...
        (async () => {
            ...
            try {
                ...
                const Zt = rt
                  ...
                  , na = typeof Zt == "object" && typeof Zt.status == "number" ? Zt.status : 200;
                (na === 401 || na === 419) && (h({
                    message: Ln,
                    type: "error"
                }),
    ...
    const ya = async ce => {
        ...
        try {
            ...
            const Ae = Re
              ...
              , aa = typeof Ae == "object" && typeof Ae.status == "number" ? Ae.status : 200;
            (aa === 401 || aa === 419) && (h({
                message: Le,
                type: "error"
            }),
      ...
      , se = async () => {
        ...
        try {
            ...
            const Re = fe
              ...
              , Le = typeof Re == "object" && typeof Re.status == "number" ? Re.status : 200;
            (Le === 401 || Le === 419) && (h({
                message: Ae,
                type: "error"
            }),
                    ...
                    children: [f.jsx("div", {
                        ...
                        children: [f.jsx("label", {
                            ...
                            children: [f.jsx("input", {
                                ...
                                onClick: L.length >= 6 && !G ? Ba : void 0,
                                ...
                                children: G ? ((xt = o == null ? void 0 : o.checking) == null ? void 0 : xt[s]) + "..." : (At = o == null ? void 0 : o.verify) == null ? void 0 : At[s]
                            })]
                        })]
                    }), Q && f.jsxs("div", {
                        className: "my-4",
                        children: [f.jsx("label", {
                            ...
                            children: [f.jsx("option", {
                                ...
                                disabled: !0,
                                hidden: !0,
                                children: (cl = o == null ? void 0 : o.lblInputAppointment) == null ? void 0 : cl[s]
                        ...
                        children: [f.jsx("label", {
                            ...
                            children: [f.jsx("option", {
                                ...
                                disabled: !0,
                                hidden: !0,
                                children: (Ci = o == null ? void 0 : o.selectAppointmentTime) == null ? void 0 : Ci[s]
                        ...
                        children: [f.jsxs("div", {
                            ...
                            children: [f.jsx("input", {
                                ...
                                type: "button",
                                onClick: !ye && !Z ? La : void 0,
                                disabled: j.length !== 6 || ye || Z,
                                className: `h-10 px-4 text-sm font-medium rounded-md text-white transition-colors duration-300 ${j.length === 6 && !Z && !ye ? "bg-green-600 hover:bg-green-700 hover:cursor-pointer" : "bg-gray-400 cursor-not-allowed"}`,
                                children: ye ? ((on = o == null ? void 0 : o.checking) == null ? void 0 : on[s]) + "..." : Z ? (fl = o == null ? void 0 : o.verified) == null ? void 0 : fl[s] : (Ha = o == null ? void 0 : o.verify) == null ? void 0 : Ha[s]
                            })]
                        }), f.jsx("div", {
                            className: "w-full flex items-center gap-2",
                            children: wa !== "" && f.jsx("p", {
    ...
    ${$e && !at ? "bg-green-600 hover:bg-green-700 cursor-pointer" : "bg-gray-400 cursor-not-allowed"}`,
                        disabled: !$e || at,
                        onClick: $e && !at ? se : void 0,
                        children: at ? ((Pa = o == null ? void 0 : o.processing) == null ? void 0 : Pa[s]) + "..." : (rn = o == null ? void 0 : o.payNow) == null ? void 0 : rn[s]
                    }), f.jsx("p", {
      ...
      , $ = async () => {
        try {
            ...
            const G = ae
              ...
              , ye = typeof G == "object" && typeof G.status == "number" ? G.status : 200;
            (ye === 401 || ye === 419) && Lt(n),
            m({
                message: ve,
                type: "error"
...
fb.createRoot(document.getElementById("root")).render(f.jsx(S.StrictMode, {
    children: f.jsx(Aw, {})
}));
